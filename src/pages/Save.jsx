...
const styles = {
  ...
  logo: { display: "block", textAlign: "center", marginBottom: 36, fontSize: 22, fontWeight: 700, letterSpacing: "-0.5px", color: "#F5F0E8", textDecoration: "none" },
  logoAccent: { color: "#F5E6C8" },
  card: { background: "#1A1916", border: "1px solid rgba(245,230,200,0.12)", borderRadius: 16, overflow: "hidden" },
  previewStrip: { background: "rgba(245,230,200,0.05)", borderBottom: "1px solid rgba(245,230,200,0.1)", padding: "20px 28px", display: "flex", flexDirection: "column", gap: 10 },
  previewRow: { display: "flex", justifyContent: "space-between", alignItems: "center" },
  previewLabel: { fontSize: 13, color: "rgba(245,240,232,0.5)", textTransform: "uppercase", letterSpacing: "0.08em", fontWeight: 500 },
  previewValue: { fontSize: 15, fontWeight: 600, color: "#F5E6C8", letterSpacing: "-0.2px" },
  cardBody: { padding: "36px 28px 32px" },
  eyebrow: { fontSize: 12, fontWeight: 600, color: "#C8A96E", textTransform: "uppercase", letterSpacing: "0.1em", margin: "0 0 12px 0" },
  heading: { fontSize: 28, fontWeight: 700, color: "#F5F0E8", letterSpacing: "-0.8px", lineHeight: 1.15, margin: "0 0 14px 0" },
  subheading: { fontSize: 15, lineHeight: 1.65, color: "rgba(245,240,232,0.6)", margin: "0 0 28px 0" },
  form: { display: "flex", flexDirection: "column", gap: 12 },
  input: { width: "100%", padding: "14px 16px", fontSize: 16, background: "rgba(245,230,200,0.06)", border: "1px solid rgba(245,230,200,0.18)", borderRadius: 10, color: "#F5F0E8", outline: "none", boxSizing: "border-box", fontFamily: "inherit" },
  button: { display: "flex", alignItems: "center", justifyContent: "center", padding: "15px 24px", fontSize: 16, fontWeight: 600, background: "#F5E6C8", color: "#0F0E0C", border: "none", borderRadius: 10, cursor: "pointer", fontFamily: "inherit", letterSpacing: "-0.2px" },
  buttonDisabled: { opacity: 0.5, cursor: "not-allowed" },
  errorText: { fontSize: 14, color: "#E87060", margin: 0 },
  privacy: { fontSize: 12, color: "rgba(245,240,232,0.3)", lineHeight: 1.6, margin: "16px 0 0 0" },
  successCard: { background: "#1A1916", border: "1px solid rgba(245,230,200,0.12)", borderRadius: 16, padding: "48px 32px", textAlign: "center" },
  successIcon: { width: 60, height: 60, borderRadius: "50%", background: "rgba(200,169,110,0.15)", border: "1.5px solid rgba(200,169,110,0.4)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 28px", color: "#C8A96E" },
  successHeading: { fontSize: 32, fontWeight: 700, color: "#F5F0E8", letterSpacing: "-1px", margin: "0 0 16px 0" },
  successBody: { fontSize: 16, lineHeight: 1.65, color: "rgba(245,240,232,0.7)", margin: "0 0 12px 0" },
  successSub: { fontSize: 13, lineHeight: 1.6, color: "rgba(245,240,232,0.35)", margin: "0 0 28px 0" },
  successDivider: { height: 1, background: "rgba(245,230,200,0.1)", margin: "0 0 24px 0" },
  successNext: { fontSize: 15, lineHeight: 1.65, color: "rgba(245,240,232,0.65)", margin: "0 0 28px 0" },
  successLink: { display: "inline-block", fontSize: 14, color: "#C8A96E", textDecoration: "none", borderBottom: "1px solid rgba(200,169,110,0.4)", paddingBottom: 2 },
};
